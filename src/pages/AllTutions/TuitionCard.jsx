...
const TuitionCard = ({ tuition }) => {
  return (
    <motion.div
      ...
      className="h-full"
    >
      <div className="relative group bg-base-100 rounded-[2rem] p-7 shadow-lg shadow-primary/10 hover:shadow-2xl hover:shadow-primary/30 transition-all duration-500 border border-base-300 flex flex-col h-full overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col h-full">
          {/* Header */}
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 text-primary border border-primary/20">
              <BookOpen size={14} className="animate-pulse" />
          ...
          {/* Title */}
          <div className="mb-5">
            <p className="text-xs font-semibold text-base-content/60 uppercase tracking-tighter mb-1">
              Tuition Category
            </p>
          ...
          {/* Info */}
          <div className="grid grid-cols-2 gap-3 mb-8">
            <div className="bg-base-200 p-3 rounded-2xl border border-transparent group-hover:border-primary/20 group-hover:bg-base-100 transition-all">
              <div className="flex items-center gap-2 text-primary mb-1">
                <MapPin size={14} />
            ...
            <div className="bg-base-200 p-3 rounded-2xl border border-transparent group-hover:border-success/30 group-hover:bg-base-100 transition-all">
          ...
          <Link
            to={`/tuitions/${tuition._id}`}
            className="group/btn relative inline-flex items-center justify-center px-8 py-4 font-bold text-primary-content transition-all duration-300 bg-gradient-to-r from-primary via-indigo-500 to-primary bg-size-200 bg-pos-0 hover:bg-pos-100 rounded-2xl shadow-lg shadow-primary/25 overflow-hidden"
          >
            <span className="relative z-10 flex items-center gap-2">
              View Details
              <ArrowRight
