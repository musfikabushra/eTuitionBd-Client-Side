...
const Hero = () => {
  ...
  return (
    <section className="relative bg-base-200 py-16 md:py-28 overflow-hidden min-h-[90vh] flex items-center">
      ...
      <motion.div 
        animate={{ scale: [1, 1.3, 1], rotate: [0, -90, 0] }}
        transition={{ duration: 15, repeat: Infinity }}
        className="absolute bottom-[-10%] right-[-5%] w-[500px] h-[500px] bg-secondary/10 rounded-full blur-3xl"
      />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          ...
          {/* Left Side */}
          <motion.div style={{ y: y1 }} className="flex-1 text-center md:text-left">
            <motion.div
              initial={{ opacity: 0, x: -30 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.8 }}
            >
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-black leading-[1.1] text-base-content tracking-tight">
                Find the Perfect{" "}
                <span className="bg-gradient-to-r from-primary via-indigo-500 to-primary bg-clip-text text-transparent">
                  Tutor
                </span>
                <br className="hidden lg:block" /> for Your Success
              </h1>

              <p className="mt-8 text-lg md:text-xl text-base-content/70 leading-relaxed max-w-xl mx-auto md:mx-0">
                eTuitionBd connects students with verified expert tutors for
                high-quality, personalized learning. Start your journey today!
              </p>
              ...
              <div className="mt-10 flex flex-wrap justify-center md:justify-start gap-4">
                ...
                <Link
                  to="/register"
                  className="btn btn-ghost btn-lg rounded-2xl border-2 border-base-300 hover:border-primary hover:text-primary transition-all gap-2 px-10"
                >
                  <BookOpen size={20} />
                  Become a Tutor
                </Link>
              ...
              <div className="mt-12 flex items-center justify-center md:justify-start gap-10">
                <div>
                  <span className="text-3xl font-black text-base-content">5k+</span>
                  <span className="block text-xs uppercase tracking-widest font-bold text-base-content/60">
                    Expert Tutors
                  </span>
                </div>
                <div className="h-10 w-[2px] bg-base-300"></div>
                <div>
                  <span className="text-3xl font-black text-base-content">4k+</span>
                  <span className="block text-xs uppercase tracking-widest font-bold text-base-content/60">
                    Active Students
                  </span>
                </div>
          ...
          {/* Right Side Image */}
          <motion.div style={{ y: y2 }} className="flex-1 relative w-full max-w-[600px]">
            <motion.div
              initial={{ opacity: 0, scale: 0.9, rotate: 2 }}
              animate={{ opacity: 1, scale: 1, rotate: 0 }}
            ...
            >
              <motion.div
                ...
                className="relative"
              >
                <div className="absolute -inset-4 bg-gradient-to-tr from-primary/30 to-secondary/30 rounded-[2.5rem] blur-2xl opacity-50"></div>

                <img
                  src={hero}
                  alt="Quality Learning"
                  className="relative rounded-[2rem] shadow-2xl object-cover w-full aspect-[4/3] border-8 border-base-100"
                />
                ...
                <motion.div
                  ...
                  className="absolute -bottom-10 -left-10 bg-base-100 p-5 rounded-2xl shadow-2xl hidden sm:flex items-center gap-4 border border-base-300"
                >
                ...
                <motion.div
                  ...
                  className="absolute -top-10 -right-5 bg-primary p-4 rounded-2xl shadow-2xl hidden sm:block text-primary-content"
                >
                  <p className="text-center">
                    <span className="block text-2xl font-black">08+</span>
